...
class Car:
    def __init__(self, engine, wheels, cabin, tpms_id, fuel_tank):
        self.engine = engine
...
print("car wheels:", my_car.wheels[0].wheel_location)
print("car wheels Serial #:", my_car.wheels[0].tpms_di.serial_number)
